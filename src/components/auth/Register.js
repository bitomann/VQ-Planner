...
const Register = props => {
    const [credentials, setCredentials] = useState({userName: "", confirmUserName: ""})
    ...
    const handleRegister = evt => {
        ...
        if (credentials.userName === "" && credentials.confirmUserName === "") {
            window.alert("Please input a F3 Name.")
        } else if (credentials.userName !== credentials.confirmUserName) {
            window.alert("F3 Names do not match.")
        } else {
        ...
        <form onSubmit={handleRegister}>
            <fieldset>
                ...
                <div className="formgrid">
                    ...
                    <label htmlFor="confirmUserName">Confirm F3 Name :</label>
                    <input onChange={handleFieldChange} type="confirmUserName" id="confirmUserName" 
                    placeholder="Confirm F3 Name..." required=""></input>
                </div>
